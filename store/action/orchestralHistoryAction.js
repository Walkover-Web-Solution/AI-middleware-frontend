...
import { setError, setHistoryData, setLoading, setThreadData } from "../reducer/orchestralHistoryReducer";
...
export const getOrchestralHistoryAction = (agentId) => async (dispatch) => {
  if (!agentId) return [];
  dispatch(setLoading(true));
  dispatch(setError(null));
  try {
    const payload = await getOrchestralHistory(agentId);
