...
function Navbar() {
  ...
  return (
    <div className={` ${router.pathname === '/' ? 'hidden' : 'flex items-center justify-between '} w-full navbar border flex-wrap md:flex-nowrap sticky top-0 z-50 bg-white/50 backdrop-blur`}>
