...
function Navbar() {
  ...
  return (
    <div className={` ${router.pathname === '/' ? 'hidden' : 'flex items-center justify-between '} w-full navbar border flex-wrap md:flex-nowrap sticky top-0 z-[100] max-h-[4rem] bg-base-100`}>
