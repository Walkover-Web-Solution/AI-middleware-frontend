...
function Navbar() {
  ...
  return (
    <div className="flex items-center justify-between w-full navbar bg-base-100 border-b">
     ...
     <div
        ref={sidebarRef}
        className={` inset-y-0 left-0 border-r-1 ${
          isOpen
                  ...
                  .map((org) => (
                    <li key={org.id}>
                      <a
                        ...
                        className={`${
                          path[2] === org.id ? 'font-semibold text-primary' : ''
                        } capitalize`}
                      >
                        {org.name}
                      </a>
                  ...
                  <li key={bridge.id}>
                    <a
                      onClick={() => {
                        toggleBridgeSidebar();
                        router.push(
                          `/org/${path[2]}/bridges/configure/${bridge.id}`
                        );
                      }}
                      className={`${
                        path[5] === bridge.id ? 'font-semibold text-primary' : ''
                      } capitalize truncate`}
                  ...
                  <li key={chatbot.id}>
                    <a
                      onClick={() => {
                        ...
                        router.push(`/org/${path[2]}/chatbot/${chatbot.id}`);
                      }}
                      className={`${
                        path[4] === chatbot.id ? 'font-semibold text-primary' : ''
                      } capitalize`}
                    >
                      {chatbot.title}
                    </a>
