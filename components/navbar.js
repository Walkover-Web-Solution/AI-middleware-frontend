...
import { TestTube, MessageCircleMore, Pause, Play, ClipboardX, BookCheck, MoreVertical, Clock, Home, HistoryIcon, ArchiveRestore, Archive, BotIcon, Variable, ChevronDown } from 'lucide-react';
...
const Navbar = ({ isEmbedUser, params, searchParams }) => {
  ...
  console.log("Navbar Debug:", { orgId, bridgeId, versionId, pathParts });
        ...
        <div className="flex w-full items-center justify-between px-6 h-10">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center ml-2 sm:ml-6 lg:ml-0 md:ml-0 xl:ml-0 min-w-0 flex-1">
              <div className="flex items-center px-2 py-2 rounded-lg min-w-0 max-w-fit cursor-pointer">
                {!isEditingName ? (
                  <span 
                    ...
                    {isDrafted && (
                      <li>
                        <button
                          ...
                          className="flex items-center gap-2 px-3 py-2 text-xs hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
