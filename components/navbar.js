...
function Navbar({ isEmbedUser }) {
  ...
  return (
    <div className='z-[999]'>
      <div className={` ${pathName === '/' || pathName.endsWith("alerts") ? 'hidden' : (!isEmbedUser ? 'flex items-center justify-between flex-wrap' : ' ')} w-full navbar border md:flex-nowrap z-[19] max-h-[4rem] bg-base-100 sticky top-0`}>
