        ...
        <section className="bg-base-100 border border-base-300 rounded-lg shadow-sm p-4 flex-1 flex flex-col">
          <div className="flex items-center justify-between border-b border-base-200 pb-3">
            ...
            <div className="flex gap-2">
              ...
              {bulkEditMode && (
                <>
                  <button type="button" className="btn btn-ghost btn-xs" onClick={handleBulkEditToggle}>
                    Cancel
                  </button>
                  <button type="button" className="btn btn-primary btn-xs" onClick={handleBulkEditSave}>
                    Save Changes
                  </button>
                </>
              )}
