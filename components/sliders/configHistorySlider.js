...
function ConfigHistorySlider({ versionId }) {
  ...
  return (
    <aside
      ...
      className="sidebar-container fixed flex flex-col top-0 right-0 p-4 w-full md:w-1/3 lg:w-1/6 opacity-100 h-screen bg-base-200 transition-all duration-300 z-[103] border-l overflow-y-auto translate-x-full"
