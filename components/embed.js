...
SendDataToChatbot = function (dataToSend) {
    if (dataToSend.parentId || dataToSend.parentId === '') {
        ...
        if (!props['parentId'] && document.getElementById(parentContainer)) { document.body.removeChild(parentContainer) } else { document.getElementById(props['parentId'])?.removeChild(parentContainer) }
