...
const AddEnvironmentVariable = ({ id, setShowAddVariablePopup }) => {
  ...
  return (
    <div className="fixed top-0 right-0 h-screen w-2/5 bg-gray-100 shadow-lg p-8 z-50 overflow-hidden transition-all ease-in duration-500">
