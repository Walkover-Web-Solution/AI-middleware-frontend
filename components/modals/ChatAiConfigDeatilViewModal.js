...
const ChatAiConfigDeatilViewModal = ({modalContent}) => {
  return (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-[1000] overflow-auto min-w-[100vw]">
        <div className="bg-white p-4 rounded shadow-lg max-w-6xl w-[90vw] relative">
          ...
          <div className="bg-gray-200 p-4 rounded text-sm overflow-auto h-[80vh] ">
