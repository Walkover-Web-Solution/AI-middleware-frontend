        ...
        <div className="flex text-base-content justify-end gap-2">
          ...
          {hasGeneratedPrompt ? (
            <>
              ...
              <button className="btn btn-secondary btn-sm gap-2" onClick={handleShowGeneratedPrompt}>
            ...
            <button className="btn btn-primary btn-sm gap-2" onClick={handleImprovePrompt}>
              {isImprovingPrompt ? (
                <>
