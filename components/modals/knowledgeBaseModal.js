...
const KnowledgeBaseModal = ({ params, selectedKnowledgeBase = null, setSelectedKnowledgeBase = () => { }, knowledgeBaseData = [], knowbaseVersionData = [], searchParams, addToVersion = false }) => {
  ...
  const getInitialState = useCallback(() => ({
    ...
    url: selectedKnowledgeBase?.source?.data?.url || '',
    sectionType: 'default',
    chunking_type: '',
    chunk_size: selectedKnowledgeBase?.chunk_size || '',
    chunk_overlap: selectedKnowledgeBase?.chunk_overlap || '',
  ...
  const isUnchanged = JSON.stringify(formData) === JSON.stringify(getInitialState());
                ...
                {selectedSectionType === 'custom' && (
                  <div className="form-control">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        handleInputChange(e);
                        setChunkingType(e.target.value);
                      }}
                    >
