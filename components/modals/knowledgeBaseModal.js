  ...
  return (
    <dialog id={MODAL_TYPE.KNOWLEDGE_BASE_MODAL} className="modal backdrop-blur-sm">
      <div className="modal-box w-11/12 max-w-3xl border-2">
        <div className="flex items-center justify-between mb-3 pb-4 border-b border-base-300">
          ...
          <div className="grid grid-cols-1 gap-4 rounded-lg">
            <div className="space-y-2">
              <div className="form-control">
                <div className="label">
                  <span className="label-text text-md">Knowledge Base Name</span>
                </div>
                <input
                  type="text"
                  name="name"
              ...
              <div className="form-control">
                <label className="label !px-0">
                  <span className="label-text text-sm">Choose Upload Method</span>
                </label>
              ...
              {!isUpload ? (
                <div className="form-control">
                  <label className="label !px-0">
                    <span className="label-text text-sm">Google Documentation URL</span>
                  </label>
                  <input
                    type="url"
                    name="doc_url"
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text text-sm">Upload Document (PDF, Word, CSV)</span>
                  </label>
                  <input
                    type="file"
                    name="file"
          ...
          <div className="grid grid-cols-1 gap-4 rounded-lg">
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="form-control">
                  <label className="label !px-0">
                    <span className="label-text text-sm">Processing Method</span>
                  </label>
                  <select
                    name="sectionType"
                ...
                {selectedSectionType === 'custom' && (
                  <div className="form-control">
                    <label className="label !px-0">
                      <span className="label-text text-sm">Chunking Type</span>
                    </label>
                    <select
                      name="chunking_type"
                      className="select select-bordered select-md focus:ring-1 ring-primary/40"
              ...
              {selectedSectionType === 'custom' && chunkingType !== 'semantic' && chunkingType && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="form-control">
                    <label className="label !px-0">
                      <span className="label-text text-sm">Chunk Size</span>
                    </label>
                    <input
                      type="number"
                      name="chunk_size"
                  ...
                  <div className="form-control">
                    <label className="label !px-0">
                      <span className="label-text text-sm">Chunk Overlap</span>
                    </label>
                    <input
                      type="number"
                      name="chunk_overlap"
