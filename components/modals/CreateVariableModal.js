            ...
            <div id="create-variable-modal-container" className="modal-box" key={keyName}>
                ...
                <div className="modal-action">
                    <form method="dialog">
                        ...
                        <button id="create-variable-close-button"className="btn btn-sm" onClick={handleCloseModal}>Close</button>
                        <button id="create-variable-create-button"className="btn btn-sm btn-primary ml-2" onClick={CreateVariable}>Create</button>
                    </form>
                </div>
                {/* </form> */}
            </div>
