          ...
          <div className="px-6 py-4 space-y-6">
            ...
            {finalTestCases && finalTestCases.length > 2 && !showFullConversation && (
              <div className="flex xs">
                <button type="button" onClick={() => setShowFullConversation(true)} className="btn btn-outline btn-sm">
            ...
            {showFullConversation && finalTestCases && finalTestCases.length > 2 && (
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-base-300 pb-2">
                  <button type="button" onClick={() => setShowFullConversation(false)} className="btn btn-ghost btn-sm">
                    Hide Conversations
                  </button>
                </div>
