...
const DefaultVariablesSection = memo(({ prompt = '', customVariables = [], isPublished = false }) => {
   ...
   // Extract variables used in the prompt
    ...
    return (
        <div className="bg-gradient-to-r bg-base-1 border-t-0 border border-base-content/10 rounded-t-none">
                ...
                <div className="flex items-center gap-2 flex-1">
                    ...
                    {usedVariables.length > 0 && (
                        <div className="flex items-center gap-1">
                            ...
                            <p role="alert" className="label-text-alt p-1 bg-success/20 text-success inline-block w-fit text-xs rounded">
                                &#123;&#123;{usedVariables[0]}&#125;&#125;
            ...
            {isExpanded && (
                <div className="border-t border-base-content/10 p-3 bg-base-50">
                    ...
                    <div className="text-xs text-base-content/60 mt-3 p-2 bg-info/10 rounded border-l-2 border-info">
                        <strong>Usage:</strong> Use custom variables like {`{{your_custom_variable}}`}, created from Variable section, to insert dynamic values into your prompt.
                    </div>
                </div>
            )}
        </div>
