    ...
    return (
        <div className="relative form-control w-auto text-base-content" ref={apiKeySectionRef}>
            ...
            disabled={isPublished}
                ...
                size="sm"
                className="flex w-full items-center justify-between gap-2 rounded-md border px-3 py-2 text-sm whitespace-nowrap transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 border-white/[0.08] text-gray-100 h-10 focus:border-blue-500/50 min-w-[150px]"
