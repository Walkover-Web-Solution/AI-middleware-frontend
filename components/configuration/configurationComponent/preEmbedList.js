                ...
                <div className="label flex-col items-start">
                    {shouldToolsShow &&
                        <div className="flex flex-wrap gap-4">
                            <RenderEmbed  bridgeFunctions={bridgePreFunctions} integrationData={integrationData} getStatusClass={getStatusClass} handleOpenModal={handleOpenModal} embedToken={embedToken} params={params}/>
                        </div>}
                </div>
            </div>
        </div> :
