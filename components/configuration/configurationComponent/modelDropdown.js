...
const ModelPreview = memo(({ hoveredModel, modelSpecs }) => {
    ...
    return (
        <div className="max-w-[400px] w-[250px] bg-white border border-gray-200 rounded-lg shadow-lg p-6 mt-8 top-10 absolute left-[260px] transition-transform duration-300 ease-in-out z-low-medium transform hover:scale-105">
            ...
            <div className="w-full max-w-xs">
                ...
                <div className="dropdown w-full font-normal" ref={dropdownRef}>
                    ...
                    {isDropdownOpen && (
                        <ul
                            tabIndex={0}
                            className="dropdown-content dropdown-left z-low p-2 shadow bg-white rounded-lg  mt-1 max-h-[500px] w-[260px] overflow-y-auto border border-gray-100"
