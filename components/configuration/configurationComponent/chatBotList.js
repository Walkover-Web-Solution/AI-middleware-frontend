        ...
        <div className="form-control">
            ...
            <div className='flex flex-wrap gap-4'>
                {chatbotData?.map((chatBot, index) => (
                    <div key={index} onClick={() => router.push(`/org/${params.org_id}/chatbot/configure/${chatBot._id}`)} className="flex max-w-xs flex-col items-center rounded-md border border-base-300 md:flex-row cursor-pointer transform transition duration-150 ease-in-out hover:bg-base-200">
                        <div>
                            <div className="p-4">
