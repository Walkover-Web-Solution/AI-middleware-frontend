                    ...
                    <>
                      ...
                      {selectedPrebuiltTools.map((item) => {
                        ...
                        return (
                          <div
                            key={item?.value}
                            className={`group flex w-full items-center rounded-md border border-base-300 cursor-pointer bg-base-100 relative ${hasIssue ? 'border-error' : ''} hover:bg-base-200 transition-colors duration-200 min-h-[44px]`}
                          >
