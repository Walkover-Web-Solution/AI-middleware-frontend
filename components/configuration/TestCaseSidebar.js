...
import { Play, Clock, AlertCircle, Eye, EyeOff, History, ChevronDown, ChevronRight } from 'lucide-react';
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <button
                      ...
                      className={runningTests.has(testCase._id) ? 'bg-transparent' : 'p-1.5 bg-primary rounded hover:bg-primary/80 disabled:opacity-50 disabled:cursor-not-allowed relative'}
                      title="Run Test"
                    >
                      {runningTests.has(testCase._id) ? (
