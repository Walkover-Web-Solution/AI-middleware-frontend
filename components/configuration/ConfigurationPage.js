...
export default function ConfigurationPage({ params }) {
  ...
  const handleNavigation = (target) => {
    ...
    router.push(
      `/org/${params.org_id}/bridges/configure/${params.id}?version=${params.version}&view=${target}`
    );
  };
