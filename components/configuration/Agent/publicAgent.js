    ...
    useEffect(() => {
        if (token) {
            ...
            if (token) {
                ...
                script.setAttribute("embedToken", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJvcmdfaWQiOiI4MjY5IiwiY2hhdGJvdF9pZCI6IjY2OWI3MTk1NmFmNDg2MmQ5MWYwYjg0MyIsInVzZXJfaWQiOjEyMzF9.xIc3glMmvSWO85M2Tn1Iyc0HtFYdm6f_UrLsqPXYihg");
