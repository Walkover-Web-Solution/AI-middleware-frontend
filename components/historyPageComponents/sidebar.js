                      ...
                      >
                        <a className="w-full h-full flex items-center justify-between relative group">
                          ...
                          {item?.thread_id?.length > 35 && (
                            <div className="absolute left-0 top-full mt-1 bg-gray-800 text-base-content text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-low max-w-[300px] break-words shadow-lg pointer-events-none">
                              {item?.thread_id}
                            </div>
                          )}
