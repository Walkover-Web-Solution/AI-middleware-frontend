  ...
  return (
    ...
    >
        ...
        <div className="relative w-8 h-8 mb-3">
            ...
            <div className="absolute inset-0 w-8 h-8 border-4 border-transparent border-t-base-content rounded-full animate-spin" 
                //  style={{ 
        ...
        <span className="text-base-content text-sm font-normal tracking-wide animate-pulse" 
