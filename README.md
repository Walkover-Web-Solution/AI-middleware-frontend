...
<blockquote>
  <p><b>Tip:</b> If <code>.env.example</code> exists, copy it. Never commit <code>.env.local</code>.</p>
</blockquote>
...
<pre><code>NEXT_PUBLIC_PYTHON_SERVER_URL=http://localhost:8000
NEXT_PUBLIC_SERVER_URL=http://localhost:7072</code></pre>
...
<table>
  ...
  <tr><td><code>npm run format</code></td><td>Format code (if configured)</td></tr>
</table>
