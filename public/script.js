/* eslint-disable */
// var urlToViasocket = `http://localhost:3001/i`
...
createProps()
console.log("this is creat props",createProps());
...
loadChatbotEmbed = async function () {
  ...
  fetch(loginurl, requestOptions)
    .then(async (response) => {
      ...
      console.log("data received from fetch api ",data)
      return data
    })
    .then((data) => {
...
var loadContent = function (parentId = props.parentId || '', bodyLoadedHai = bodyLoaded) {
    console.log("body laod hai",bodyLoadedHai)
    console.log("body parent id hai",parentId)
...
var changeContainer = function (parentId) {
    console.log("parent id hai",parentId)
  ...
  // Ensure SendTempDataToChatbot is called after the container change
