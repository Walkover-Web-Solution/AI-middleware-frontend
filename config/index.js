...
export const getSystemPromptHistory = async({bridge_id, pageNo,limit}) => {
   try{
     const response = await axios.get(`${URL}/api/v1/config/getallsystemprompts/${bridge_id}?pageNo=${pageNo}&limit=${limit}`)
