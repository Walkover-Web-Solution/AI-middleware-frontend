        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-stretch justify-between w-3/4 mx-auto gap-8">
            {PRICINGPLANS?.map((plan) => (
              <div key={plan.name} className="flex-1 w-full rounded-md p-10 flex flex-col justify-between border-opacity-40 border-gray-400 border-[0.1px] relative overflow-hidden group hover:bg-zoom">
                <div>
