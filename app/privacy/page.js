...
export const metadata = {
  title: "Privacy | GTWY AI",
  description: "Privacy policy for GTWY AI platform - how we protect your data and information when using our AI middleware and integration services",
  category: 'technology',
  generator: 'GTWY AI',
        ...
        <div data-custom-class="body">
              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="subtitle">
                    Last updated <bdt className="question">February 10, 2025</bdt>
                  </span>
                </span>
              </strong>
            </span>
          ...
          <div>
            ...
            <ul>
              <li data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: 15 }}>
                  Use <bdt className="question">GTWY AI</bdt>.{" "}
                  <bdt className="question">integrate AI into your product</bdt>
                </span>
                <bdt className="statement-end-if-in-editor">
                  <span style={{ fontSize: 15 }} />
                </bdt>
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              <a
                data-custom-class="link"
                href="https://app.termly.io/notify/e79d4853-d1b1-47ed-a624-390e92a68792"
