...
const ModelDocs = () => {
  ...
  return (
    <div className="bg-gray-300 min-h-[100vh] overflow-hidden flex gap-0 flex-col">
      <navbar className="bg-black w-full p-[20px]  flex items-center justify-between px-[4rem]">
      ...
      <div className="max-w-4xl min-w-[full] mx-auto bg-white rounded-xl shadow-lg space-y-6 p-[30px] my-[10px]">
        ...
        {filteredSections.length ? (
          filteredSections.map((section) => (
            <div key={section.id} id={section.id}>
              <h1 className="text-md font-bold text-black font-serif">
                {section.title}
              </h1>
          ...
          <div className="space-y-2 mb-8">
            ...
            <div>
              {sections.map((section) => (
                <div key={section.id} id={section.id} className="mt-[20px]">
                  <h1 className="text-md font-bold text-black font-serif">
                    {section.title}
                  </h1>
                  <p className="text-md text-gray-700">{section.description}</p>
