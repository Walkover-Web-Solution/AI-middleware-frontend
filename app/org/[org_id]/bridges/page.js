              ...
              <div className="flex flex-col">
                ...
                <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-5 lg:grid-cols-4 p-4">
                  {filteredBridges.slice().sort((a, b) => a.name.localeCompare(b.name)).map((item) => (
                    <div key={item._id} data-id={item._id} className="flex flex-col items-center gap-7 rounded-md border cursor-pointer hover:shadow-lg" onClick={() => onClickConfigure(item._id)}>
                      <div className="w-full">
                        <div className="p-4 flex flex-col justify-between h-[200px] items-start">
                          ...
                          <div className="mt-auto flex justify-between w-full">
                            ...
                            <button onClick={(e) => { e.stopPropagation(); handleDeleteBridge(item._id); }} className="btn btn-sm btn-error">
