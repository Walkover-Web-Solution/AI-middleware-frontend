...
import {
  ...
  deleteAuthData,
  getAllAuthData,
} from "@/store/action/authkeyAction";
      ...
      <dialog id={MODAL_TYPE.PAUTH_KEY_DELETE_MODAL} className="modal">
        <div className="modal-box">
          <h3 className="font-bold text-lg">
            Do you want to delete {singleAuthData.name} ?
          </h3>
